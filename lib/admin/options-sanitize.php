...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', 'icy'),
		'repeat-x'  => __('Repeat Horizontally', 'icy'),
		'repeat-y'  => __('Repeat Vertically', 'icy'),
		'repeat'    => __('Repeat All', 'icy'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'icy'),
		'top center'    => __('Top Center', 'icy'),
		'top right'     => __('Top Right', 'icy'),
		'center left'   => __('Middle Left', 'icy'),
		'center center' => __('Middle Center', 'icy'),
		'center right'  => __('Middle Right', 'icy'),
		'bottom left'   => __('Bottom Left', 'icy'),
		'bottom center' => __('Bottom Center', 'icy'),
		'bottom right'  => __('Bottom Right', 'icy')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', 'icy'),
		'fixed'  => __('Fixed in Place', 'icy')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __('Normal', 'icy'),
		'italic'      => __('Italic', 'icy'),
		'bold'        => __('Bold', 'icy'),
		'bold italic' => __('Bold Italic', 'icy')
		);
